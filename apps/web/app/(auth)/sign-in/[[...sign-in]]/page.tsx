      ...
      <SignIn
        appearance={{
          ...
          elements: {
            rootBox: "w-full",
            card:
              "w-full border border-[var(--beacon-border)] bg-[color-mix(in_srgb,var(--beacon-surface)_88%,transparent)] shadow-[0_24px_80px_rgba(0,0,0,0.08)] backdrop-blur-xl dark:shadow-[0_24px_80px_rgba(0,0,0,0.35)]",
            header:
              "gap-2",
            headerTitle:
            ...
            footer:
              "border-t border-[var(--beacon-border)] bg-transparent",
            footerActionText:
